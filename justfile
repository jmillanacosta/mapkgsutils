...
doctests:
    uv run --group doctests --all-extras xdoctest -m src/mapkgsutils
...
mypy:
    uv run --group typing --all-extras mypy --ignore-missing-imports --strict --explicit-package-bases src/ tests/
